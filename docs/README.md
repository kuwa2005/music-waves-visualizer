...
| [VIDEO_BACKGROUND.md](./VIDEO_BACKGROUND.md) | MP4 as music vs background video, UI rules, recording MIME, related issues (#34–#36) |
...
| [VIDEO_BACKGROUND.md](./VIDEO_BACKGROUND.md) | MP4 を音楽用／背景動画用に分ける挙動・D&D 規則・録画 MIME・関連 Issue |
