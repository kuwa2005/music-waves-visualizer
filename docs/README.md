...
| [SESSION_20260601.md](./SESSION_20260601.md) | 2026-06 session hub: screen tab, modes 17–21, v1.0.6, subtitle/render perf (PR #41) |
...
| [SESSION_20260601.md](./SESSION_20260601.md) | 画面タブ・モード17–21・v1.0.6・描画/字幕パフォーマンス（PR #41） |
