...
| [SESSION_20260601.md](./SESSION_20260601.md) | 2026-06 session hub: screen tab, modes 17–21, v1.0.6 (laser, pickers, audio tab merge, graceful stop) |
...
| [articles/today-is-what-day.md](./articles/today-is-what-day.md) | Rewritten note article draft and header image prompt |
...
| [SESSION_20260601.md](./SESSION_20260601.md) | 画面タブ・モード17–21・v1.0.6（レーザー・ピッカー・音設定統合・早期停止フェード） |
